                ...
                <table style="width: 920px; border: 1px solid #333; border-collapse: collapse; background: #FBE4D5;">
                    <tr style="border-bottom: 1px solid #333;">
                        <td style="width: 50%; padding: 3px 10px; border-right: 1px solid black;">
                            <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">NAME:</span>  Isbel M Beach</p>
                        </td>
                        <td style="width: 50%;">
                            <table style="border-collapse: collapse;">
                                <tr>
                                    <td style="width: 25%; padding: 3px 10px; border-right: 1px solid black;">
                                        <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">DATE:</span>  8/8/2022</p>
                                    </td>
                                    <td style="width: 25%; padding: 3px 10px;">
                                        <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">CONTRACT</span> #0808221</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="border-bottom: 1px solid #333;">
                        <td style="padding: 3px 10px;">
                            <table>
                                <tr><td>
                                    <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">ADDRESS:</span>  7270 Freedom St, Hollywood, FL 33024</p>
                                </td></tr>
                            </table>
                        </td>
                    </tr>
                    <tr style="border-bottom: 1px solid #333;">
                        <td style="padding: 3px 10px; border-right: 1px solid black;">
                            <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">PHONE NUMBER: </span>  (954) 303-9855 </p>
                        </td>
                        <td style="padding: 3px 10px;">
                            <p style="font-size: 14px; line-height: 22x; font-weight: 500;"><span style="font-weight: 600;">EMAIL:</span> elishevab273@gmail.com</p>
                        </td>
                    </tr>
                    <tr style="border-bottom: 1px solid #333;">
                        <td style="padding: 3px 10px;">
                            <p style="font-size: 14px; line-height: 22px; font-weight: 500;"><span style="font-weight: 600;">JOB DESCRIPTION:</span>  Re Roof Shingle to Dimensional Shingle And Flat to Flat</p>
                        </td>
                    </tr>
